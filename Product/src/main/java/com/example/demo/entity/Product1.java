...
public class Product1 {
	...
	public Product1(Integer id, String sku, String name, String description, float unitPrice,String imageUrl, char active,
	...
	public String toString() {
		return "Product1 [id=" + id + ", sku=" + sku + ", name=" + name + ", Description=" + Description
